...
pub fn point_mutation_naive<R: Rng>(pop: &mut PopU8, bits_used: usize, pm: f64, rng: &mut R) {
...
pub fn point_mutation<R: Rng>(pop: &mut PopU8, bits_used: usize, pm: f64, rng: &mut R) {
    for ind in pop.0.iter_mut() {
